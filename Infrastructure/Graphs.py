...
class Graphs():
    ...
    def generation_cost_plot(self, file_name="GenerationCostPlot.jpeg"):
        plt.figure(1)
    ...
    def best_ind_plot(self, file_name="BestIndPlot.jpeg"):
        plt.figure(1)
    ...
    def best_ind_constraints_plot(self, file_name="ConstraintsEvolution.jpeg"):
